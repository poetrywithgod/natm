...
export default function ShadowTeacherNotifications() {
  ...
  if (loading) {
    return <div className="p-4 font-ui text-forest-300 text-sm">Loading notifications...</div>;
  }

  if (items.length === 0) {
    return <div className="p-4 font-ui text-forest-300 text-sm">No notifications yet.</div>;
  }
