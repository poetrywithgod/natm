...
import { fetchCurriculumForClassTeacher, type CurriculumDocView } from "../features/curriculum/api";
import CurriculumList from "../components/CurriculumList";

export default function ClassTeacherCurriculum() {
  ...
  useEffect(() => {
    ...
    fetchCurriculumForClassTeacher(profile.id, profile.school_id)
      .then(setDocs)
    ...
    <div className="p-4 space-y-4 pb-8">
      <div>
        ...
        <p className="font-ui text-xs text-forest-300 mt-1">
          This term's subjects for your class. Updates automatically when the term changes.
        </p>
      </div>
